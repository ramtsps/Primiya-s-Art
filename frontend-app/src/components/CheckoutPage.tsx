...
export function CheckoutPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (isSubmitting || !agreeToTerms) return;
    ...
    try {
      ...
      // Redirect to profile page orders tab after modal is shown
          ...
          <div className="lg:col-span-2">
            <form onSubmit={onSubmit} className="space-y-6" noValidate>
              ...
              <Button
                ...
                className="w-full bg-purple-600 hover:bg-purple-700 disabled:opacity-50 cursor-pointer py-6 text-lg"
              >
                {isSubmitting ? (
                  <>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="text-center space-y-4">
              <p className="text-gray-600">
                Your order has been successfully placed. You will receive a confirmation email with all the details shortly.
              </p>
